...
bool TextureShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, const_cast<WCHAR*>(L"../Project1/texture.vs"), const_cast<WCHAR*>(L"../Project1/texture.ps"));
	if (!result)
	{
		return false;
	}
...
bool TextureShaderClass::SetFilter(ID3D11Device* device, D3D11_FILTER filter)
{
