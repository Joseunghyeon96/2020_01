...
private:
	...
	struct LightType
	{
		...
		D3DXVECTOR4 ka;		//ambient color
		D3DXVECTOR4 kd;	//diffuse color
		D3DXVECTOR4 ks;		//specular color
		float d;					//opacity
	};
...
public:
	...
	bool Initialize(ID3D11Device*, char*, string, char*);
	void Shutdown();
	bool Render(ID3D11DeviceContext*, D3DXMATRIX, D3DXMATRIX, D3DXVECTOR3, D3DXVECTOR4, D3DXVECTOR4, D3DXVECTOR3, D3DXVECTOR4, float, bool[3]);
...
private:
	...
	LightType* m_textureFileLightType;
