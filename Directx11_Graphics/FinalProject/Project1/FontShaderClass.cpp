...
bool FontShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, const_cast<WCHAR*>(L"../Project1/font.vs"), const_cast<WCHAR*>(L"../Project1/font.ps"));
	if (!result)
	{
		return false;
	}
...
// This setup needs to match the VertexType stucture in the ModelClass and in the shader.
	...
	// Create a Font sampler state description.
